...
namespace bc
{
	namespace lex
	{
		enum bcTokenType
		{
			tt_nullptr, tt_string, tt_int, tt_float, tt_object, tt_var, tt_bool, tt_scolon, tt_colon, tt_dcolon, tt_comma, tt_period, tt_squote,
			...
			tt_intlit, tt_strlit, tt_fltlit, tt_ident, tt_comment, tt_dec, tt_const,
