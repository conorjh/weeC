...
namespace wcIDE.Demo {
	public partial class MainForm : Form {
		...
		private void InitSyntaxColoring() {
			...
			TextArea.SetKeywords(0, "while else if function return const namespace true false");
			TextArea.SetKeywords(1, "void bool int float string");
        ...
        private void aSTViewerToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var co = new TreeView();
            co.Show();
        }
