...
namespace weec {
	namespace test
	{
		...
		{
			return utils::Test_ExpressionParserTemplate(listing::list_expression52, 0);
		}

		inline int Test_wcExpressionParser_53()
		{
			return utils::Test_ExpressionParserTemplate(listing::list_expression53, 0);
		}

		inline int Test_wcExpressionParser_54()
		{
			return utils::Test_ExpressionParserTemplate(listing::list_expression54, 0);
		}

		inline int Test_wcExpressionParser_55()
		{
			return utils::Test_ExpressionParserTemplate(listing::list_expression55, 0);
		}

		inline int Test_wcExpressionParser_56()
		{
			return utils::Test_ExpressionParserTemplate(listing::list_expression56, 0);
		}

		inline int Test_wcExpressionParser_57()
		{
			return utils::Test_ExpressionParserTemplate(listing::list_expression57, 0);
		}

		inline int Test_wcExpressionParser_58()
		{
			return utils::Test_ExpressionParserTemplate(listing::list_expression58, 0);
		}

		inline int Test_wcExpressionParser_59()
		{
			return utils::Test_ExpressionParserTemplate(listing::list_expression59, 0);
		}

		inline int Test_wcExpressionParser_60()
		{
			return utils::Test_ExpressionParserTemplate(listing::list_expression60, 0);
		}

		inline int Test_wcExpressionParser_61()
		{
			return utils::Test_ExpressionParserTemplate(listing::list_expression61, 0);
		}

		inline int Test_wcExpressionParser_62()
		{
			return utils::Test_ExpressionParserTemplate(listing::list_expression62, 0);
		}

		inline int Test_wcExpressionParser_63()
		{
			return utils::Test_ExpressionParserTemplate(listing::list_expression63, 0);
		}
	}
}
